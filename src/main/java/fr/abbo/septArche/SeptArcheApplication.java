...
@OpenAPIDefinition(
	info = @Info(
		title = "7eArche",
		version = "1.0.0",
		description = "L'application 7eArche est une librairie dédiée à la vente d'articles sur le cinéma." +
			" Elle offre une plateforme permettant aux utilisateurs de découvrir, " +
			"explorer et acheter des produits liés au thème de la Septième Merveille, tels que des livres, des affiches de films," +
		...
		contact = @Contact(
			name = "Abdoulaye Bognoua",
			email = "ngandos.ba@gmail.com"
		),
		license = @License(
				name = "licence"
		)
